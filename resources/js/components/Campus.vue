<template>
<div>
  <div class=" container flex justify-center items-center pt-5 animate__animated animate__rubberBand">
    <h1 class="text-secondary text-3xl hover:text-primary font-bold" >Akij Foundation School and College’s Campus</h1>
  </div>
        ...
        <div class="p-4 md:w-1/3">
          <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white rounded hover:shadow-lg p-1">
            ...
            <div class="p-6">
              ...
              <p class="leading-relaxed mb-3">In 2014 AFSC opened a campus in Manikganj Sadar.
                The school is an English Version institute following the National Curriculum.</p>
              <div class="flex items-center flex-wrap ">
                <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">See Details
                  <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
