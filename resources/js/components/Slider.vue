<template>
<div>
  <div class="mb-5 mt-2 rounded-sm shadow-sm">
      ...
      <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-5 left-1/2">
          ...
          <button aria-current="false"
                  aria-label="Slide 2"
                  class="w-3 h-3 rounded-full bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800" data-carousel-slide-to="1" type="button"></button>
          <button aria-current="false"
                  aria-label="Slide 3"
                  class="w-3 h-3 rounded-full bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800" data-carousel-slide-to="2" type="button"></button>
          <button aria-current="false"
                  aria-label="Slide 4"
                  class="w-3 h-3 rounded-full bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800" data-carousel-slide-to="3" type="button"></button>
          <button aria-current="false"
                  aria-label="Slide 5"
        ...
        <button class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
          ...
          <span
              ...
              <svg aria-hidden="true" class="w-5 h-5 text-white sm:w-6 sm:h-6 dark:text-gray-800" fill="none"
                  ...
                  d="M15 19l-7-7 7-7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
        ...
        <button class="absolute top-0 right-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
          ...
          <span
              ...
              <svg aria-hidden="true" class="w-5 h-5 text-white sm:w-6 sm:h-6 dark:text-gray-800" fill="none"
                   stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path
                  d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
